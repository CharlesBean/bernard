defmodule BernardApi.Clients.Plaid do
  ...
  @doc """
  Lists all Plaid transactions using for a given access_token, start date, and end date

  Start and end dates must be in ISO8601 format: "MM-DD-YY"
  """
  def list_transactions(access_token, start_date, end_date, count \\ 100, offset \\ 0) do
  ...
  @doc """
  Exchanges a public_token generated by Plaid Link for a short-term access_token
  and the item_id of the Plaid Item linking the user to their institution
  """
